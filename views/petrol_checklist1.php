<div class="view active" id="view-form">
    ...
    <p class="subtitle">Fire & security compliance checklist for petrol stations.</p>
    ...
    <div class="card">
        ...
        <div class="grid-2">
            <div class="field"><label>Entity Name <span class="required">*</span></label><input type="text" id="f-name" placeholder="e.g. Kigali Heights Petrol Station"></div>
